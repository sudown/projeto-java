...
public class BebidaAlcoolica extends Bebida {
  ...
  public BebidaAlcoolica(String nome, int id, double preco, int quantidade, String tipo, String marca, String descricao,
      String dataValidade, double teorAlcoolico, String tipoBebidaAlcoolica) {
